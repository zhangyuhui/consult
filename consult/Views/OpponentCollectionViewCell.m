...
- (void)setShowConnectionState:(BOOL)showConnectionState {
    _showConnectionState = showConnectionState;
    self.statusLabel.hidden = !showConnectionState;
}
